...
int main(int argc, char const *argv[])
{
    ...
    imwrite(cross_rt_img, "../out/ca1/Cross_downsample2.pgm");

    transform::Fourier fourier;
    fourier.transform(cross_rt_img);

    Image cross_rt_amplitude_img = fourier.getSpectrumImg();
    imwrite(cross_rt_amplitude_img, "../out/ca1/cross_ds2_amplitude.pgm");

    Image cross_rt_phase_img = fourier.getPhaseImg();
    imwrite(cross_rt_phase_img, "../out/ca1/cross_ds2_phase.pgm");
