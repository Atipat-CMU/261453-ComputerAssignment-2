...
int main(int argc, char const *argv[])
{
    ...
    imwrite(cross_rt_img, "../out/ca1/Cross_rotate30.pgm");

    transform::Fourier fourier;
    fourier.transform(cross_rt_img);

    Image cross_rt_amplitude_img = fourier.getSpectrumImg();
    imwrite(cross_rt_amplitude_img, "../out/ca1/cross_rt30_amplitude.pgm");

    Image cross_rt_phase_img = fourier.getPhaseImg();
    imwrite(cross_rt_phase_img, "../out/ca1/cross_rt30_phase.pgm");
